...
>Tho phase translation - когда комилятор компилирует шаблонный код, ему приходится делать это в два прохода. Сначала до подставление шаблона T, потом после подставления шаблона T
...
struct my_is_same<T,T> {
	static constexpr bool value = truel
};
////
...
50:00
https://www.youtube.com/watch?v=AR4PrVppY_4