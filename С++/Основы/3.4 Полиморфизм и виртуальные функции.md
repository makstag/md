...
Обычные указатели на методы хранят в первых восьми байтах реальные адреса функции и эти адреса всегда четные из-за выравнивания. Виртуальные указатели хранят сдвиг относительительно начала виртуальной таблицы + последний бит единицу. По этой единице в run-time можно понять это указатель на виртуальный или невиртуальный метод.
